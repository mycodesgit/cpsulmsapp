...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed text-sm">
    ...
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ asset('template/img/user.png') }}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ asset('template/img/user.png') }}" alt="User Avatar" class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                    John Pierce
        ...
        <aside class="main-sidebar main-sidebar-custom sidebar-light-primary elevation-0">
            <a href="../../index3.html" class="brand-link border-1">
                {{-- <img src="{{ asset('template/img/CPSU_L.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"> --}}
                <span class="brand-text font-weight-light">CPSU Learning Managment System</span>
            </a>
            <!-- Sidebar -->
            <div class="sidebar">
            ...
            <!-- /.sidebar -->
            <div class="sidebar-custom mt-2 mb-2" style="border-top: none;">
                <a href="{{ route('logout') }}" class="btn btn-outline-danger btn-sm btn-block">
                    <i class="fas fa-power-off"></i>
                    <span id="logout-label" class="">Logout</span>
                </a>
        ...
        <footer class="main-footer" style="border-top: none">
            ...
            <strong>Copyright &copy; 2024-2025 <a href="#">CPSU LMS</a>.</strong> All rights reserved.
        </footer>
        <!-- Control Sidebar -->
    ...
    @if(request()->routeIs('virtual_subjectclass', 'virtual_facultysubjectclass'))
    <script src="{{ asset('js/ajax/lms/topicSerialize.js') }}"></script>
    @endif
